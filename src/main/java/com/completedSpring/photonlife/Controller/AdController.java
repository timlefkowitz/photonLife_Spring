...
import com.completedSpring.photonlife.services.EmailService;
import com.completedSpring.photonlife.services.StringService;
...
public class AdController {
    ...
    public AdController(PostRepository adDao, UsersRepository usersDao, StringService stringService, EmailService emailService){
        this.adsDao = adDao;
...
//        model.addAttribute("shortUserName", shortUserName);
    ...
    public String show(@PathVariable long id, Model model){
        ...
        String shortUserName = stringService.shortenString(Post.getOwner().getUserName());
        model.addAttribute("shortUsername", shortUserName);
        return "ads/show";
    }
